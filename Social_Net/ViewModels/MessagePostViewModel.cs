...
namespace FB_Like_Sample.ViewModels
{
    internal class MessagePostViewModel
    {
        ...
        public static void CreateMessagePost001(ref Post post, Person person)
        {
            ...
            post.PostedOn = new DateTime(2023, 1, 6);
            post.Message = "Feeling Exited with my new MAUI Application";
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 2, 7);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 3, 8);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 4, 9);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 5, 10);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 6, 11);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 7, 15);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 8, 18);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 9, 19);
        ...
        {
            post.PostType = PostType.MessageOnly;
            post.PostedOn = new DateTime(2023, 10, 25);
