            ...
            switch (person.UserID)
            {
                case "User000":
                    ...
                    person.About = new Dictionary<AboutType, string>()
                    {
                        ...
                        {AboutType.Work, "Working in .Net platforms (C# | MAUI | Flutter | Asp.Net)" },
                ...
                case "User001":
                    ...
                    person.About = new Dictionary<AboutType, string>()
                    {
                        ...
                        {AboutType.Work, "Working in .Net platforms (WPF | MAUI | Flutter | Asp.Net)"},
                ...
                case "User004":
                    ...
                    person.About = new Dictionary<AboutType, string>()
                    {
                        ...
                        {AboutType.Work, "Working in .Net platforms (MAUI | Flutter | UWP)"},
